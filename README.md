...
# Financing initial resources for **Cards & Tokens**

## How much is asked and for what exactly ?
  - ### Summary: 40,000.0000 TLOS to buy resources for the Cards & Tokens platform.
    - ~27K TLOS for buying 300Mb RAM for three of the four smart contracts (100Mb each at 0.09 TLOS per 1Kb).
    -  ~13K TLOS for staking (CPU & BW) for all contracts.
  - ### More detailed:  
